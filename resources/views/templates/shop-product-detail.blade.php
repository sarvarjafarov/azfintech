...
@section('title', 'Disney Toys - News5')
...
@section('content')
        ...
        <div id="uc-search-modal" class="uc-modal-full uc-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog d-flex justify-center bg-white text-dark dark:bg-gray-900 dark:text-white" data-uc-height-viewport="">
                ...
                <div class="panel w-100 sm:w-500px px-2 py-10">
                    ...
                    <form class="hstack gap-1 mt-4 border-bottom p-narrow dark:border-gray-700" action="shop-product-detail%EF%B9%96.html">
        ...
        <div id="uc-menu-panel" data-uc-offcanvas="overlay: true;">
            <div class="uc-offcanvas-bar bg-white text-dark dark:bg-gray-900 dark:text-white">
                <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                    <div class="uc-logo">
                        <a href="{{ route('shopproductdetail') }}" class="h5 text-none text-gray-900 dark:text-white">
                    ...
                    <ul class="nav-y gap-narrow fw-bold fs-5" data-uc-nav>
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li><a href="{{ route('shopproductdetail') }}">Main</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Classic News</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Tech</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Classic Blog</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Gaming</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Sports</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Newspaper</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Magazine</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Travel</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Food</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('shopproductdetail') }}">Blog</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('shopproductdetail') }}">Full Width</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Grid 2 Cols</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Grid 3 Cols</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Grid 4 Cols</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="{{ route('shopproductdetail') }}">Blog - detail</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('shopproductdetail') }}">Blog detail</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Blog detail - v2</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Useful pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('shopproductdetail') }}">Sign up</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Sign in</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Reset password</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">404 page</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Coming soon</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Other pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('shopproductdetail') }}">FAQ</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Terms of use</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Privacy policy</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li class="uc-parent">
                            <a href="{{ route('shopproductdetail') }}">Shop</a>
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('shopproductdetail') }}">Shop layouts</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('shopproductdetail') }}">Shop 4 cols</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Shop 3 cols</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Shop 2 cols</a></li>
                                        <li><a href="{{ route('shopproductdetail') }}">Shop with sidebar</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('shopproductdetail') }}">Archive category</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Product detail</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Product detail - v2</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Cart</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Cart - v2</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Checkout</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Checkout - v2</a></li>
                                <li><a href="{{ route('shopproductdetail') }}">Order confirmation</a></li>
                            </ul>
                        </li>
                        <li class="hr opacity-10 my-1"></li>
                        <li><a href="{{ route('shopproductdetail') }}">Sign in</a></li>
                        <li><a href="{{ route('shopproductdetail') }}">Create an account</a></li>
                    </ul>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('shopproductdetail') }}" class="position-cover" data-caption="Laptop Cover"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('shopproductdetail') }}">Laptop Cover</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('shopproductdetail') }}" class="position-cover" data-caption="Disney Toys"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('shopproductdetail') }}">Disney Toys</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('shopproductdetail') }}" class="position-cover" data-caption="Screen Axe"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('shopproductdetail') }}">Screen Axe</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('shopproductdetail') }}" class="position-cover" data-caption="Airpods Pro"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('shopproductdetail') }}">Airpods Pro</a></h5>
                    ...
                    <div class="mini-cart-footer panel pt-3 border-top">
                        <div class="panel vstack gap-3 justify-between">
                            ...
                            <div class="mini-cart-actions vstack gap-1">
                                <a href="{{ route('shopproductdetail') }}" class="btn btn-md btn-outline-gray-100 text-dark dark:text-white dark:border-gray-700 dark:hover:bg-gray-700">View cart</a>
                                <a href="{{ route('shopproductdetail') }}" class="btn btn-md btn-primary text-white">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="uc-favorites-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog lg:max-w-500px bg-white text-dark dark:bg-gray-800 dark:text-white rounded">
                ...
                <div class="panel vstack justify-center items-center gap-2 text-center px-3 py-8">
                    ...
                    <a href="{{ route('shopproductdetail') }}" class="btn btn-sm btn-primary mt-2 uc-modal-close">Browse articles</a>
                </div>
            </div>
        </div>
        ...
        <div id="uc-gdpr-notification" class="uc-gdpr-notification uc-notification uc-notification-bottom-left lg:m-2">
            <div class="uc-notification-message">
                ...
                <p class="fs-7 mt-1 mb-2">We use cookies to ensure you get the best experience on our website. By continuing to use our site, you accept our use of cookies, <a href="{{ route('shopproductdetail') }}" class="uc-link text-underline">Privacy Policy</a>, and <a href="{{ route('shopproductdetail') }}" class="uc-link text-underline">Terms of Service</a>.</p>
                                            ...
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail') }}">The Rise of AI-Powered Personal Assistants: How They Manage</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail') }}">Tech Innovations Reshaping the Retail Landscape: AI Payments</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail') }}">Balancing Work and Wellness: Tech Solutions for Healthy</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail') }}">The Importance of Sleep: Tips for Better Rest and Recovery</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail') }}">The Future of Sustainable Living: Driving Eco-Friendly Lifestyles</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail') }}">Business Agility the Digital Age: Leveraging AI and Automation</a>
                                                    </h6>
                                                </article>
                                            </div>
                                        </div>
                        ...
                        <div class="uc-navbar min-h-72px lg:min-h-80px text-gray-900 dark:text-white" data-uc-navbar=" animation: uc-animation-slide-top-small; duration: 150;">
                            <div class="uc-navbar-left">
                                ...
                                <div class="uc-logo d-none md:d-block text-dark dark:text-white">
                                    <a href="{{ route('shopproductdetail') }}">
                                ...
                                <ul class="uc-navbar-nav gap-3 ft-tertiary fs-5 fw-medium ms-4 d-none lg:d-flex" style="--uc-nav-height: 80px">
                                                            ...
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    <div class="post-media panel overflow-hidden">
                                                                        ...
                                                                        <a href="{{ route('shopproductdetail') }}" class="position-cover"></a>
                                                                    </div>
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail') }}">Tech</a>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">Business Agility the Digital Age: Leveraging AI and Automation</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail') }}">Network</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">The Art of Baking: From Classic Bread to Artisan Pastries</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail') }}">Virtual Reality</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">AI and Marketing: Unlocking Customer Insights</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail') }}">AI Powered</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">Hidden Gems: Underrated Travel Destinations Around the World</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail') }}">Gadgets</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">The Rise of AI-Powered Personal Assistants: How They Manage</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail') }}">Startups</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">Tech Innovations Reshaping the Retail Landscape: AI Payments</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">Balancing Work and Wellness: Tech Solutions for Healthy</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">The Importance of Sleep: Tips for Better Rest and Recovery</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail') }}">Travel</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">Solo Travel: Some Tips and Destinations for the Adventurous Explorer</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">AI-Powered Financial Planning: How Algorithms Revolutionizing</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">Tech Tools for your Time Management: Enhancing Productivity</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">A Guide to The Rise of Gourmet Street Food: Trends and Top Picks</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail') }}">Trips</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">Eco-Tourism: Traveling Responsibly and Sustainably</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            ...
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail') }}">The Future of Sustainable Living: Driving Eco-Friendly Lifestyles</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                    ...
                                    <li><a href="{{ route('shopproductdetail') }}">News</a></li>
                                    <li><a href="{{ route('shopproductdetail') }}">Tech</a></li>
                                    <li><a href="{{ route('shopproductdetail') }}">Sciense</a></li>
                                    <li>
                                                    ...
                                                    <div class="row child-cols g-4">
                                                        ...
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                                ...
                                                                <li><a href="{{ route('shopproductdetail') }}">Modern</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Classic</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Grid 2 cols</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Grid 3 cols</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Grid 4 cols</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Category</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Author</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Blog single</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Blog single v2</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Blog single v3</a></li>
                                                            </ul>
                                                        </div>
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                        ...
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                                ...
                                                                <li><a href="{{ route('shopproductdetail') }}">Sign up</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Reset password</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">404</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Coming Soon</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Terms of service</a></li>
                                                                <li><a href="{{ route('shopproductdetail') }}">Privacy policy</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
            ...
            <div class="breadcrumbs panel z-1 py-2 bg-gray-25 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white">
                <div class="container max-w-xl">
                    <ul class="breadcrumb nav-x justify-center gap-1 fs-7 sm:fs-6 m-0">
                        <li><a href="{{ route('shopproductdetail') }}">Home</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                        <li><a href="{{ route('shopproductdetail') }}">Shop</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                        <li><a href="{{ route('shopproductdetail') }}">Toys</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                        <li><span class="opacity-50">Disney Toys</span></li>
                    </ul>
                </div>
            </div>
        ...
        <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/products/img-08.jpg') }}" alt="Disney Toys" data-uc-img="loading: lazy">
                                ...
                                <div class="product-slider panel swiper-parent">
                                    <div class="vstack gap-1">
                                        <div class="panel">
                                            <div class="swiper swiper-main h-100" data-uc-swiper="connect: .swiper-thumbs; items: 1; gap: 8; dots: .swiper-pagination; disable-class: d-none;">
                                                <div class="swiper-wrapper" data-uc-lightbox="">
                                                    <div class="swiper-slide">
                                                        <div class="product type-product">
                                                            <figure class="featured-image m-0 ratio ratio-3x4 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/products/img-08.jpg') }}" alt="Disney Toys" data-uc-img="loading: lazy">
                                                                <a href="{{ asset('assets/images/common/products/img-08.jpg') }}" class="position-cover" data-caption="Disney Toys"></a>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="product type-product">
                                                            <figure class="featured-image m-0 ratio ratio-3x4 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/products/img-17.jpg') }}" alt="Disney Toys" data-uc-img="loading: lazy">
                                                                <a href="{{ asset('assets/images/common/products/img-17.jpg') }}" class="position-cover" data-caption="Disney Toys"></a>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="product type-product">
                                                            <figure class="featured-image m-0 ratio ratio-3x4 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/products/img-18.jpg') }}" alt="Disney Toys" data-uc-img="loading: lazy">
                                                                <a href="{{ asset('assets/images/common/products/img-18.jpg') }}" class="position-cover" data-caption="Disney Toys"></a>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="product type-product">
                                                            <figure class="featured-image m-0 ratio ratio-3x4 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/products/img-19.jpg') }}" alt="Disney Toys" data-uc-img="loading: lazy">
                                                                <a href="{{ asset('assets/images/common/products/img-19.jpg') }}" class="position-cover" data-caption="Disney Toys"></a>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="product type-product">
                                                            <figure class="featured-image m-0 ratio ratio-3x4 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/products/img-20.jpg') }}" alt="Disney Toys" data-uc-img="loading: lazy">
                                                                <a href="{{ asset('assets/images/common/products/img-20.jpg') }}" class="position-cover" data-caption="Disney Toys"></a>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="product type-product">
                                                            <figure class="featured-image m-0 ratio ratio-3x4 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/products/img-21.jpg') }}" alt="Disney Toys" data-uc-img="loading: lazy">
                                                                <a href="{{ asset('assets/images/common/products/img-21.jpg') }}" class="position-cover" data-caption="Disney Toys"></a>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="product type-product">
                                                            <figure class="featured-image m-0 ratio ratio-3x4 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/products/img-22.jpg') }}" alt="Disney Toys" data-uc-img="loading: lazy">
                                                                <a href="{{ asset('assets/images/common/products/img-22.jpg') }}" class="position-cover" data-caption="Disney Toys"></a>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- Add Arrows -->
                                                <div class="swiper-nav swiper-next btn btn-xs md:btn-md w-32px md:w-40px xl:w-56px h-32px md:h-40px xl:h-56px bg-white text-dark rounded-circle shadow-xs position-absolute top-50 end-0 translate-middle-y me-narrow md:me-2 z-1">
                                                    <i class="unicon-chevron-right icon-1 md:icon-2"></i>
                                                </div>
                                                <div class="swiper-nav swiper-prev btn btn-xs md:btn-md w-32px md:w-40px xl:w-56px h-32px md:h-40px xl:h-56px bg-white text-dark rounded-circle shadow-xs position-absolute top-50 start-0 translate-middle-y ms-narrow md:ms-2 z-1">
                                                    <i class="unicon-chevron-left icon-1 md:icon-2"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="panel">
                                            <div class="swiper swiper-thumbs" data-uc-swiper="items: 5; gap: 8;">
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                            ...
                            <div>
                                <div class="product-details panel vstack gap-1 xl:gap-2 max-w-500px mx-auto" data-uc-sticky="bottom: true; offset: 40;">
                                    ...
                                    <div class="hstack justify-between items-center gap-2">
                                        ...
                                        <div class="product-rating hstack gap-1">
                                            <span class="hstack gap-narrow fs-7 opacity-60">5<span class="d-none sm:d-inline-block"> reviews</span></span>
                                    ...
                                    <p class="product-desc fs-6 xl:fs-5 my-2">
                                        Consetetur sadipscing elitr, syosma vero eos et accusam et justo takimata sit amet sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. <br><br>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut laliqua.
                                    </p>
                                    <form class="product-actions hstack gap-1 xl:mt-2">
                                        <input type="number" class="form-control form-control-sm lg:form-control-md w-100px dark:bg-gray-100 dark:bg-opacity-5 dark:text-white dark:border-gray-800" step="1" min="1" max="99" name="quantity" value="1" title="Qty" autocomplete="off">
                                        <button type="submit" class="btn btn-sm lg:btn-md btn-primary md:max-w-150px flex-1">Add to cart</button>
                                    </form>
                                    <ul class="nav-y mt-2 xl:mt-4 ft-secondary">
                                        ...
                                        <li class="hstack gap-narrow">
                                            ...
                                            <a class="text-primary" href="{{ route('shopproductdetail') }}">Toys</a>,
                                            <a class="text-primary" href="{{ route('shopproductdetail') }}">Games</a>
                                        </li>
                                        <li class="hstack gap-narrow">
                                            <span class="text-uppercase opacity-60 me-narrow">Tags:</span>
                                            <a class="text-primary" href="{{ route('shopproductdetail') }}">Heads toys</a>,
                                            <a class="text-primary" href="{{ route('shopproductdetail') }}">Child</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="product-tabs panel mt-8">
                        <ul class="product-tabs-nav nav-x justify-center ft-secondary h6 pb-2 border-bottom" data-uc-tab>
                        ...
                        <div class="product-tabs-content uc-switcher mt-4 max-w-lg mx-auto">
                            <div>
                                <div id="product-details" class="product-details panel py-2 lg:py-4">
                                    <p>Consetetur sadipscing elitr, syosma vero eos et accusam et justo takimata sit amet sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
                                    <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur, sed do eiusmod.</p>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid iusto dolores laudantium commodi ut ullam id, numquam repellat quo maiores excepturi cum atque consequuntur alias sunt, dignissimos architecto odio unde!</p>
                                                        ...
                                                        <div class="review-item">
                                                            <div class="vstack items-start gap-2">
                                                                <div class="vstack gap-2 flex-1">
                                                                    ...
                                                                    <p class="text-dark dark:text-white text-opacity-70">Molestiae quam exercitationem quisquam quasi veniam dolores temporibus nam doloribus, cumque quibusdam.</p>
                                                                </div>
                                                                <div class="hstack items-center gap-2 h6 ft-secondary text-dark dark:text-white text-opacity-70">
                                                                    <div class="w-40px">
                                                                        <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                            <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/users/img-01.png') }}" alt="Reviewer name" data-uc-img="loading: lazy">
                                                                        </figure>
                                                                    </div>
                                                        ...
                                                        <div class="review-item">
                                                            <div class="vstack items-start gap-2">
                                                                <div class="vstack gap-2 flex-1">
                                                                    ...
                                                                    <p class="text-dark dark:text-white text-opacity-70">Ratione quis deleniti error porro ipsum, aspernatur illo nisi officia aliquam similique.</p>
                                                                </div>
                                                                <div class="hstack items-center gap-2 h6 ft-secondary text-dark dark:text-white text-opacity-70">
                                                                    <div class="w-40px">
                                                                        <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                            <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/users/img-02.png') }}" alt="Reviewer name" data-uc-img="loading: lazy">
                                                                        </figure>
                                                                    </div>
                                                                    <div class="hstack justify-between items-center gap-2 flex-1 fs-7 fw-normal">
                                                        ...
                                                        <div class="review-item">
                                                            <div class="vstack items-start gap-2">
                                                                <div class="vstack gap-2 flex-1">
                                                                    ...
                                                                    <p class="text-dark dark:text-white text-opacity-70">Nam consequuntur aut, qui eaque molestias excepturi reiciendis quo ut fugit odio.</p>
                                                                </div>
                                                                <div class="hstack items-center gap-2 h6 ft-secondary text-dark dark:text-white text-opacity-70">
                                                                    <div class="w-40px">
                                                                        <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                            <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/users/img-03.png') }}" alt="Reviewer name" data-uc-img="loading: lazy">
                                                                        </figure>
                                                                    </div>
                                                                    <div class="hstack justify-between items-center gap-2 flex-1 fs-7 fw-normal">
                                                        ...
                                                        <div class="review-item">
                                                            <div class="vstack items-start gap-2">
                                                                <div class="vstack gap-2 flex-1">
                                                                    ...
                                                                    <p class="text-dark dark:text-white text-opacity-70">Quisquam illo iste consequatur qui aspernatur vel mollitia eaque animi autem nemo.</p>
                                                                </div>
                                                                <div class="hstack items-center gap-2 h6 ft-secondary text-dark dark:text-white text-opacity-70">
                                                                    <div class="w-40px">
                                                                        <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                            <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/users/img-04.png') }}" alt="Reviewer name" data-uc-img="loading: lazy">
                                                                        </figure>
                                                                    </div>
                                                                    <div class="hstack justify-between items-center gap-2 flex-1 fs-7 fw-normal">
                                                        ...
                                                        <div class="review-item">
                                                            <div class="vstack items-start gap-2">
                                                                <div class="vstack gap-2 flex-1">
                                                                    ...
                                                                    <p class="text-dark dark:text-white text-opacity-70">Consetetur sadipscing elitr, syosma vero eos et accusam et justo takimata sit amet sed diam nonumy eirmod tempor invidunt.</p>
                                                                </div>
                                                                <div class="hstack items-center gap-2 h6 ft-secondary text-dark dark:text-white text-opacity-70">
                                                                    <div class="w-40px">
                                                                        <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                                            <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/common/users/img-05.png') }}" alt="Reviewer name" data-uc-img="loading: lazy">
                                                                        </figure>
                                                                    </div>
                                                                    <div class="hstack justify-between items-center gap-2 flex-1 fs-7 fw-normal">
                                ...
                                document.write(
                                    new Date().getFullYear()
                                                    ...
                                                    <div class="reviews-loadmore" hidden>
                                                        <a href="#" class="btn btn-sm btn-outline-gray-100 w-100 text-dark dark:text-white dark:border-gray-700 dark:hover:bg-gray-700">Load more reviews</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="panel vstack gap-1 lg:gap-2" data-uc-sticky="bottom: true; offset: 40;">
                                                ...
                                                <p class="text-dark dark:text-white text-opacity-70">Your email address will not be published. Required fields are marked <sup class="text-danger">*</sup></p>
                                                <form class="panel vstack gap-2 lg:gap-3 mt-2" action="shop-product-detail%EF%B9%96.html">
                                                    <div class="row g-2 child-cols-12 lg:child-cols-6">
                                                        <div class="form-group">
                                                            <label class="form-label fs-7 ft-secondary" for="reviewer_name">Name <sup class="text-danger">*</sup></label>
                                                            <input type="text" id="reviewer_name" class="form-control form-control-sm dark:bg-gray-100 dark:bg-opacity-5 dark:text-white dark:border-gray-800">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label fs-7 ft-secondary" for="reviewer_email">Email <sup class="text-danger">*</sup></label>
                                                            <input type="email" id="reviewer_email" class="form-control form-control-sm dark:bg-gray-100 dark:bg-opacity-5 dark:text-white dark:border-gray-800" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label fs-7 ft-secondary">Your rating <sup class="text-danger">*</sup></label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-label fs-7 ft-secondary" for="reviewer_title">Review title <sup class="text-danger">*</sup></label>
                                                        <input type="text" id="reviewer_title" class="form-control form-control-sm dark:bg-gray-100 dark:bg-opacity-5 dark:text-white dark:border-gray-800">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label fs-7 ft-secondary" for="reviewer_message">Your review</label>
                                                        <textarea id="reviewer_message" class="form-control form-control-sm dark:bg-gray-100 dark:bg-opacity-5 dark:text-white dark:border-gray-800" rows="5" required></textarea>
                                                    </div>
                                                    <div class="form-group form-check text-start">
                                                        <input class="form-check-input rounded-0 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white dark:border-gray-800" type="checkbox" id="remember_me">
                                                        <label class="hstack justify-between form-check-label fs-7 lg:fs-6" for="remember_me">Save my name, email, and website in this browser for the next time I comment.</label>
                                                    </div>
                                                    <button class="btn btn-sm lg:btn-md btn-primary w-100">Submit review</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="featured-products-panel panel pt-4 lg:pt-8 mt-4 border-top border-gray-100 dark:border-gray-800">
                        ...
                        <div class="panel swiper-parent mt-4 md:mt-6">
                            ...
                            <!-- Swiper init -->
                            <div class="swiper" data-uc-swiper="items: 2; gap: 8; dots: .swiper-pagination; disable-class: d-none;" data-uc-swiper-s="items: 3; gap: 16;" data-uc-swiper-m="items: 4; gap: 24;" data-uc-swiper-l="items: 5; gap: 32;">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <article class="product type-product panel">
                                            <div class="vstack gap-2">
                                                <div class="panel">
                                                    <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('shopproductdetail') }}" class="position-cover" data-caption="Elegant Watch"></a>
                                                    </figure>
                                                    <span class="position-absolute top-0 start-0 m-1 fs-7 ft-secondary lh-sm h-16px px-narrow rounded bg-yellow-400 text-dark">51%</span>
                                                </div>
                                                <div class="content vstack items-center gap-1 fs-6 text-center xl:mt-1">
                                                    <h5 class="h6 lg:h5 m-0"><a class="text-none" href="{{ route('shopproductdetail') }}">Elegant Watch</a></h5>
                                                    <ul class="nav-x gap-0 text-gray-100 dark:text-gray-700" title="Average 5 out of 5">
                                            ...
                                            <div class="vstack gap-2">
                                                <div class="panel">
                                                    <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('shopproductdetail') }}" class="position-cover" data-caption="Hemp Seed"></a>
                                                    </figure>
                                                </div>
                                                <div class="content vstack items-center gap-1 fs-6 text-center xl:mt-1">
                                                    <h5 class="h6 lg:h5 m-0"><a class="text-none" href="{{ route('shopproductdetail') }}">Hemp Seed</a></h5>
                                                    <ul class="nav-x gap-0 text-gray-100 dark:text-gray-700" title="Average 4 out of 5">
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                            ...
                                            <div class="vstack gap-2">
                                                <div class="panel">
                                                    <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('shopproductdetail') }}" class="position-cover" data-caption="White Classic Watch"></a>
                                                    </figure>
                                                    <span class="position-absolute top-0 start-0 m-1 fs-7 ft-secondary lh-sm h-16px px-narrow rounded bg-yellow-400 text-dark">67%</span>
                                                </div>
                                                <div class="content vstack items-center gap-1 fs-6 text-center xl:mt-1">
                                                    <h5 class="h6 lg:h5 m-0"><a class="text-none" href="{{ route('shopproductdetail') }}">White Classic Watch</a></h5>
                                                    <ul class="nav-x gap-0 text-gray-100 dark:text-gray-700" title="Average 5 out of 5">
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                            ...
                                            <div class="vstack gap-2">
                                                <div class="panel">
                                                    <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('shopproductdetail') }}" class="position-cover" data-caption="Stylish Starbucks"></a>
                                                    </figure>
                                                </div>
                                                <div class="content vstack items-center gap-1 fs-6 text-center xl:mt-1">
                                                    <h5 class="h6 lg:h5 m-0"><a class="text-none" href="{{ route('shopproductdetail') }}">Stylish Starbucks</a></h5>
                                                    <ul class="nav-x gap-0 text-gray-100 dark:text-gray-700" title="Average 5 out of 5">
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                            ...
                                            <div class="vstack gap-2">
                                                <div class="panel">
                                                    <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('shopproductdetail') }}" class="position-cover" data-caption="Black AirTag"></a>
                                                    </figure>
                                                </div>
                                                <div class="content vstack items-center gap-1 fs-6 text-center xl:mt-1">
                                                    <h5 class="h6 lg:h5 m-0"><a class="text-none" href="{{ route('shopproductdetail') }}">Black AirTag</a></h5>
                            ...
                            <div class="row child-cols col-match gx-4 gy-6">
                                    ...
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                <li><a href="{{ route('shopproductdetail') }}">Startups and technology</a></li>
                                                <li><a href="{{ route('shopproductdetail') }}">Data and security</a></li>
                                                <li><a href="{{ route('shopproductdetail') }}">Fintech and ecommerce</a></li>
                                                <li><a href="{{ route('shopproductdetail') }}">Investors and funding</a></li>
                                                <li><a href="{{ route('shopproductdetail') }}">Corporates and innovation</a></li>
                                                <li><a href="{{ route('shopproductdetail') }}">Government and policy</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 md:col">
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                <li><a href="{{ route('shopproductdetail') }}">Media</a></li>
                                                <li><a href="{{ route('shopproductdetail') }}">Events</a></li>
                                                <li><a href="{{ route('shopproductdetail') }}">Partner with us</a></li>
                                                <li><a href="{{ route('shopproductdetail') }}">Jobs</a></li>
                                                <li><a href="{{ route('shopproductdetail') }}">Masthead</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                ...
                                                <li><a href="{{ route('shopproductdetail') }}">Log in</a></li>
                                                <li><a href="{{ route('shopproductdetail') }}">Create an account</a></li>
                                ...
                                <div class="col-12 md:col-5">
                                    <div class="widget newsletter-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            ...
                                            <p class="fs-7 fw-medium text-dark dark:text-white text-opacity-50 mt-2">By pressing the Subscribe button, you confirm that you have read and are agreeing to our <a href="{{ route('shopproductdetail') }}" class="uc-link dark:text-white">Privacy Policy</a> and <a href="{{ route('shopproductdetail') }}" class="uc-link dark:text-white">Terms of Use</a></p>
                        ...
                        <div class="uc-footer-bottom panel vstack lg:hstack gap-4 justify-between fs-7 text-center lg:text-start">
                            <div class="vstack lg:hstack gap-2">
                                ...
                                <ul class="footer-site-links nav-x gap-2 fw-medium justify-center lg:justify-start">
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('shopproductdetail') }}">Privacy notice</a></li>
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('shopproductdetail') }}">Terms of condition</a></li>
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('shopproductdetail') }}">FAQ</a></li>
                                </ul>
                            </div>
