        ...
        <div id="uc-search-modal" class="uc-modal-full uc-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog d-flex justify-center bg-white text-dark dark:bg-gray-900 dark:text-white" data-uc-height-viewport="">
                ...
                <div class="panel w-100 sm:w-500px px-2 py-10">
                    ...
                    <form class="hstack gap-1 mt-4 border-bottom p-narrow dark:border-gray-700" action="sign-up%EF%B9%96.html">
        ...
        <div id="uc-menu-panel" data-uc-offcanvas="overlay: true;">
            <div class="uc-offcanvas-bar bg-white text-dark dark:bg-gray-900 dark:text-white">
                <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                    <div class="uc-logo">
                        <a href="{{ route('signup') }}" class="h5 text-none text-gray-900 dark:text-white">
                    ...
                    <ul class="nav-y gap-narrow fw-bold fs-5" data-uc-nav>
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li><a href="{{ route('signup') }}">Main</a></li>
                                <li><a href="{{ route('signup') }}">Classic News</a></li>
                                <li><a href="{{ route('signup') }}">Tech</a></li>
                                <li><a href="{{ route('signup') }}">Classic Blog</a></li>
                                <li><a href="{{ route('signup') }}">Gaming</a></li>
                                <li><a href="{{ route('signup') }}">Sports</a></li>
                                <li><a href="{{ route('signup') }}">Newspaper</a></li>
                                <li><a href="{{ route('signup') }}">Magazine</a></li>
                                <li><a href="{{ route('signup') }}">Travel</a></li>
                                <li><a href="{{ route('signup') }}">Food</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    ...
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('signup') }}">Full Width</a></li>
                                        <li><a href="{{ route('signup') }}">Grid 2 Cols</a></li>
                                        <li><a href="{{ route('signup') }}">Grid 3 Cols</a></li>
                                        <li><a href="{{ route('signup') }}">Grid 4 Cols</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="{{ route('signup') }}">Blog - detail</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('signup') }}">Blog detail</a></li>
                                        <li><a href="{{ route('signup') }}">Blog detail - v2</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    ...
                                    <ul class="uc-nav-sub">
                                        ...
                                        <li><a href="{{ route('signup') }}">Reset password</a></li>
                                        <li><a href="{{ route('signup') }}">404 page</a></li>
                                        <li><a href="{{ route('signup') }}">Coming soon</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    ...
                                    <ul class="uc-nav-sub">
                                        ...
                                        <li><a href="{{ route('signup') }}">Terms of use</a></li>
                                        <li><a href="{{ route('signup') }}">Privacy policy</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li class="uc-parent">
                            <a href="{{ route('signup') }}">Shop</a>
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('signup') }}">Shop layouts</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('signup') }}">Shop 4 cols</a></li>
                                        <li><a href="{{ route('signup') }}">Shop 3 cols</a></li>
                                        <li><a href="{{ route('signup') }}">Shop 2 cols</a></li>
                                        <li><a href="{{ route('signup') }}">Shop with sidebar</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('signup') }}">Archive category</a></li>
                                <li><a href="{{ route('signup') }}">Product detail</a></li>
                                <li><a href="{{ route('signup') }}">Product detail - v2</a></li>
                                <li><a href="{{ route('signup') }}">Cart</a></li>
                                <li><a href="{{ route('signup') }}">Cart - v2</a></li>
                                <li><a href="{{ route('signup') }}">Checkout</a></li>
                                <li><a href="{{ route('signup') }}">Checkout - v2</a></li>
                                <li><a href="{{ route('signup') }}">Order confirmation</a></li>
                            </ul>
                        </li>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('signup') }}" class="position-cover" data-caption="Laptop Cover"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('signup') }}">Laptop Cover</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('signup') }}" class="position-cover" data-caption="Disney Toys"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('signup') }}">Disney Toys</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('signup') }}" class="position-cover" data-caption="Screen Axe"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('signup') }}">Screen Axe</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('signup') }}" class="position-cover" data-caption="Airpods Pro"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('signup') }}">Airpods Pro</a></h5>
                    ...
                    <div class="mini-cart-footer panel pt-3 border-top">
                        <div class="panel vstack gap-3 justify-between">
                            ...
                            <div class="mini-cart-actions vstack gap-1">
                                <a href="{{ route('signup') }}" class="btn btn-md btn-outline-gray-100 text-dark dark:text-white dark:border-gray-700 dark:hover:bg-gray-700">View cart</a>
                                <a href="{{ route('signup') }}" class="btn btn-md btn-primary text-white">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="panel vstack md:items-center justify-center h-screen overflow-hidden">
                                    <div data-anime="targets: >*; translateY: [-24, 0]; opacity: [0, 1]; easing: easeInOutCubic; duration: 750; delay: anime.stagger(100);">
                                        <div class="uc-logo cstack mx-auto mb-6 lg:mb-8">
                                            <a href="{{ route('signup') }}">
                                                <img class="w-100px lg:w-128px text-dark dark:text-white hover:text-primary transition-color duration-150 d-none dark:d-block" src="{{ asset('assets/images/demo-three/common/logo-dark.svg') }}" alt="Create an account">
                                                <img class="w-100px lg:w-128px text-dark dark:text-white hover:text-primary transition-color duration-150 d-block dark:d-none" src="{{ asset('assets/images/demo-three/common/logo-light.svg') }}" alt="Create an account">
                                            </a>
                                        </div>
                                    </div>
                                            ...
                                            <form class="vstack gap-2">
                                                ...
                                                <div class="hstack text-start">
                                                    <div class="form-check text-start">
                                                        ...
                                                        <label for="form_accept_terms" class="hstack justify-between form-check-label fs-6">I read and accept the <a href="{{ route('signup') }}" class="uc-link ms-narrow">terms of use</a>. </label>
                                                    </div>
                                                </div>
                                                <button class="btn btn-primary btn-sm mt-1" type="submit">Create my account</button>
                                            </form>
                                            <p>Already have an account? <a class="uc-link" href="{{ route('signup') }}">Sign in</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
