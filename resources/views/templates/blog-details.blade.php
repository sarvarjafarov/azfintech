...
@section('content')
        ...
        <div id="uc-search-modal" class="uc-modal-full uc-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog d-flex justify-center bg-white text-dark dark:bg-gray-900 dark:text-white" data-uc-height-viewport="">
                ...
                <div class="panel w-100 sm:w-500px px-2 py-10">
                    ...
                    <form class="hstack gap-1 mt-4 border-bottom p-narrow dark:border-gray-700" action="blog-details%EF%B9%96.html">
        ...
        <div id="uc-menu-panel" data-uc-offcanvas="overlay: true;">
            <div class="uc-offcanvas-bar bg-white text-dark dark:bg-gray-900 dark:text-white">
                <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                    <div class="uc-logo">
                        <a href="{{ route('blogdetails') }}" class="h5 text-none text-gray-900 dark:text-white">
                    ...
                    <ul class="nav-y gap-narrow fw-bold fs-5" data-uc-nav>
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li><a href="{{ route('blogdetails') }}">Main</a></li>
                                <li><a href="{{ route('blogdetails') }}">Classic News</a></li>
                                <li><a href="{{ route('blogdetails') }}">Tech</a></li>
                                <li><a href="{{ route('blogdetails') }}">Classic Blog</a></li>
                                <li><a href="{{ route('blogdetails') }}">Gaming</a></li>
                                <li><a href="{{ route('blogdetails') }}">Sports</a></li>
                                <li><a href="{{ route('blogdetails') }}">Newspaper</a></li>
                                <li><a href="{{ route('blogdetails') }}">Magazine</a></li>
                                <li><a href="{{ route('blogdetails') }}">Travel</a></li>
                                <li><a href="{{ route('blogdetails') }}">Food</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('blogdetails') }}">Blog</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('blogdetails') }}">Full Width</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Grid 2 Cols</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Grid 3 Cols</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Grid 4 Cols</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="{{ route('blogdetails') }}">Blog - detail</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('blogdetails') }}">Blog detail</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Blog detail - v2</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Useful pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('blogdetails') }}">Sign up</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Sign in</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Reset password</a></li>
                                        <li><a href="{{ route('blogdetails') }}">404 page</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Coming soon</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Other pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('blogdetails') }}">FAQ</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Terms of use</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Privacy policy</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li class="uc-parent">
                            <a href="{{ route('blogdetails') }}">Shop</a>
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('blogdetails') }}">Shop layouts</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('blogdetails') }}">Shop 4 cols</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Shop 3 cols</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Shop 2 cols</a></li>
                                        <li><a href="{{ route('blogdetails') }}">Shop with sidebar</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('blogdetails') }}">Archive category</a></li>
                                <li><a href="{{ route('blogdetails') }}">Product detail</a></li>
                                <li><a href="{{ route('blogdetails') }}">Product detail - v2</a></li>
                                <li><a href="{{ route('blogdetails') }}">Cart</a></li>
                                <li><a href="{{ route('blogdetails') }}">Cart - v2</a></li>
                                <li><a href="{{ route('blogdetails') }}">Checkout</a></li>
                                <li><a href="{{ route('blogdetails') }}">Checkout - v2</a></li>
                                <li><a href="{{ route('blogdetails') }}">Order confirmation</a></li>
                            </ul>
                        </li>
                        <li class="hr opacity-10 my-1"></li>
                        <li><a href="{{ route('blogdetails') }}">Sign in</a></li>
                        <li><a href="{{ route('blogdetails') }}">Create an account</a></li>
                    </ul>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('blogdetails') }}" class="position-cover" data-caption="Laptop Cover"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('blogdetails') }}">Laptop Cover</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('blogdetails') }}" class="position-cover" data-caption="Disney Toys"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('blogdetails') }}">Disney Toys</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('blogdetails') }}" class="position-cover" data-caption="Screen Axe"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('blogdetails') }}">Screen Axe</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('blogdetails') }}" class="position-cover" data-caption="Airpods Pro"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('blogdetails') }}">Airpods Pro</a></h5>
                    ...
                    <div class="mini-cart-footer panel pt-3 border-top">
                        <div class="panel vstack gap-3 justify-between">
                            ...
                            <div class="mini-cart-actions vstack gap-1">
                                <a href="{{ route('blogdetails') }}" class="btn btn-md btn-outline-gray-100 text-dark dark:text-white dark:border-gray-700 dark:hover:bg-gray-700">View cart</a>
                                <a href="{{ route('blogdetails') }}" class="btn btn-md btn-primary text-white">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="uc-favorites-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog lg:max-w-500px bg-white text-dark dark:bg-gray-800 dark:text-white rounded">
                ...
                <div class="panel vstack justify-center items-center gap-2 text-center px-3 py-8">
                    ...
                    <a href="{{ route('blogdetails') }}" class="btn btn-sm btn-primary mt-2 uc-modal-close">Browse articles</a>
                </div>
            </div>
        </div>
        ...
        <div id="uc-gdpr-notification" class="uc-gdpr-notification uc-notification uc-notification-bottom-left lg:m-2">
            <div class="uc-notification-message">
                ...
                <p class="fs-7 mt-1 mb-2">We use cookies to ensure you get the best experience on our website. By continuing to use our site, you accept our use of cookies, <a href="{{ route('blogdetails') }}" class="uc-link text-underline">Privacy Policy</a>, and <a href="{{ route('blogdetails') }}" class="uc-link text-underline">Terms of Service</a>.</p>
                                            ...
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blogdetails') }}">The Rise of AI-Powered Personal Assistants: How They Manage</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blogdetails') }}">Tech Innovations Reshaping the Retail Landscape: AI Payments</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blogdetails') }}">Balancing Work and Wellness: Tech Solutions for Healthy</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blogdetails') }}">The Importance of Sleep: Tips for Better Rest and Recovery</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blogdetails') }}">The Future of Sustainable Living: Driving Eco-Friendly Lifestyles</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blogdetails') }}">Business Agility the Digital Age: Leveraging AI and Automation</a>
                                                    </h6>
                                                </article>
                                            </div>
                                        </div>
                        ...
                        <div class="uc-navbar min-h-72px lg:min-h-80px text-gray-900 dark:text-white" data-uc-navbar=" animation: uc-animation-slide-top-small; duration: 150;">
                            <div class="uc-navbar-left">
                                ...
                                <ul class="uc-navbar-nav gap-3 ft-tertiary fs-5 fw-medium ms-4 d-none lg:d-flex" style="--uc-nav-height: 80px">
                                                            ...
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    <div class="post-media panel overflow-hidden">
                                                                        ...
                                                                        <a href="{{ route('blogdetails') }}" class="position-cover"></a>
                                                                    </div>
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blogdetails') }}">Tech</a>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">Business Agility the Digital Age: Leveraging AI and Automation</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blogdetails') }}">Network</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">The Art of Baking: From Classic Bread to Artisan Pastries</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blogdetails') }}">Virtual Reality</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">AI and Marketing: Unlocking Customer Insights</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blogdetails') }}">AI Powered</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">Hidden Gems: Underrated Travel Destinations Around the World</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blogdetails') }}">Gadgets</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">The Rise of AI-Powered Personal Assistants: How They Manage</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blogdetails') }}">Startups</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">Tech Innovations Reshaping the Retail Landscape: AI Payments</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">Balancing Work and Wellness: Tech Solutions for Healthy</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">The Importance of Sleep: Tips for Better Rest and Recovery</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blogdetails') }}">Travel</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">Solo Travel: Some Tips and Destinations for the Adventurous Explorer</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">AI-Powered Financial Planning: How Algorithms Revolutionizing</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">Tech Tools for your Time Management: Enhancing Productivity</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">A Guide to The Rise of Gourmet Street Food: Trends and Top Picks</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blogdetails') }}">Trips</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">Eco-Tourism: Traveling Responsibly and Sustainably</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            ...
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blogdetails') }}">The Future of Sustainable Living: Driving Eco-Friendly Lifestyles</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                    ...
                                    <li><a href="{{ route('blogdetails') }}">News</a></li>
                                    <li><a href="{{ route('blogdetails') }}">Tech</a></li>
                                    <li><a href="{{ route('blogdetails') }}">Sciense</a></li>
                                    <li>
                                                    ...
                                                    <div class="row child-cols g-4">
                                                        ...
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                                ...
                                                                <li><a href="{{ route('blogdetails') }}">Modern</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Classic</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Grid 2 cols</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Grid 3 cols</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Grid 4 cols</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Category</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Author</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Blog single</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Blog single v2</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Blog single v3</a></li>
                                                            </ul>
                                                        </div>
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                        ...
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                                ...
                                                                <li><a href="{{ route('blogdetails') }}">Sign up</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Reset password</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">404</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Coming Soon</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Terms of service</a></li>
                                                                <li><a href="{{ route('blogdetails') }}">Privacy policy</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
            ...
            <div class="breadcrumbs panel z-1 py-2 bg-gray-25 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white">
                <div class="container max-w-xl">
                    <ul class="breadcrumb nav-x justify-center gap-1 fs-7 sm:fs-6 m-0">
                        <li><a href="{{ route('blogdetails') }}">Home</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                        <li><a href="{{ route('blogdetails') }}">Blog</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                        <li><a href="{{ route('blogdetails') }}">Strategy</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                    ...
                    <div class="post-header">
                        <div class="panel vstack gap-4 md:gap-6 xl:gap-8 text-center">
                            <div class="panel vstack items-center max-w-400px sm:max-w-500px xl:max-w-md mx-auto gap-2 md:gap-3">
                                <h1 class="h4 sm:h2 lg:h1 xl:display-6">The Rise of Gourmet Street Food: Trends and Top Picks</h1>
                                        ...
                                        <div class="new-post panel hstack w-100 sm:w-1/2">
                                            <div class="panel hstack justify-center w-100px h-100px">
                                                <figure class="featured-image m-0 ratio ratio-1x1 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                    ...
                                                    <a href="{{ route('blogdetails') }}" class="position-cover" data-caption="Tech Innovations Reshaping the Retail Landscape: AI Payments"></a>
                                                </figure>
                                            </div>
                                        ...
                                        <div class="new-post panel hstack w-100 sm:w-1/2">
                                            ...
                                            <div class="panel hstack justify-center w-100px h-100px">
                                                <figure class="featured-image m-0 ratio ratio-1x1 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                    ...
                                                    <a href="{{ route('blogdetails') }}" class="position-cover" data-caption="The Rise of AI-Powered Personal Assistants: How They Manage"></a>
                                                </figure>
                                            </div>
                                            <a href="{{ route('blogdetails') }}" class="position-cover"></a>
                                        </div>
                                            ...
                                            <div>
                                                <article class="post type-post panel vstack gap-2">
                                                    <figure class="featured-image m-0 ratio ratio-4x3 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blogdetails') }}" class="position-cover" data-caption="The Art of Baking: From Classic Bread to Artisan Pastries"></a>
                                                    </figure>
                                                    <div class="post-header panel vstack gap-1">
                                                        <h5 class="h6 md:h5 m-0">
                                                            <a class="text-none" href="{{ route('blogdetails') }}">The Art of Baking: From Classic Bread to Artisan Pastries</a>
                                                        </h5>
                                            ...
                                            <div>
                                                <article class="post type-post panel vstack gap-2">
                                                    <figure class="featured-image m-0 ratio ratio-4x3 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blogdetails') }}" class="position-cover" data-caption="AI and Marketing: Unlocking Customer Insights"></a>
                                                    </figure>
                                                    <div class="post-header panel vstack gap-1">
                                                        <h5 class="h6 md:h5 m-0">
                                                            <a class="text-none" href="{{ route('blogdetails') }}">AI and Marketing: Unlocking Customer Insights</a>
                                                        </h5>
                                                        <div class="post-date hstack gap-narrow fs-7 opacity-60">
                                                            <span>Feb 22, <script>
                                document.write(
                                            ...
                                            <div>
                                                <article class="post type-post panel vstack gap-2">
                                                    <figure class="featured-image m-0 ratio ratio-4x3 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blogdetails') }}" class="position-cover" data-caption="Hidden Gems: Underrated Travel Destinations Around the World"></a>
                                                    </figure>
                                                    <div class="post-header panel vstack gap-1">
                                                        <h5 class="h6 md:h5 m-0">
                                                            <a class="text-none" href="{{ route('blogdetails') }}">Hidden Gems: Underrated Travel Destinations Around the World</a>
                                                        </h5>
                                                        <div class="post-date hstack gap-narrow fs-7 opacity-60">
                                                            <span>Feb 14, <script>
                                document.write(
                                            ...
                                            <div>
                                                <article class="post type-post panel vstack gap-2">
                                                    <figure class="featured-image m-0 ratio ratio-4x3 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blogdetails') }}" class="position-cover" data-caption="Eco-Tourism: Traveling Responsibly and Sustainably"></a>
                                                    </figure>
                                                    <div class="post-header panel vstack gap-1">
                                                        <h5 class="h6 md:h5 m-0">
                                                            <a class="text-none" href="{{ route('blogdetails') }}">Eco-Tourism: Traveling Responsibly and Sustainably</a>
                                                        </h5>
                                                        <div class="post-date hstack gap-narrow fs-7 opacity-60">
                                                            <span>Feb 8, <script>
                                document.write(
                                                ...
                                                <div class="show-featured clearfix">
                                                    <div class="post-img">
                                                        <a
                                                            ...
                                                            <img width="1200" height="700"
                                                                src="https://reactheme.com/news5/news-magazine/wp-content/uploads/sites/26/2025/04/lifestyle.webp"
                                                                class="attachment-full size-full wp-post-image" alt=""
                                                                decoding="async"
                                                                srcset="https://reactheme.com/news5/news-magazine/wp-content/uploads/sites/26/2025/04/lifestyle.webp 1200w, https://reactheme.com/news5/news-magazine/wp-content/uploads/sites/26/2025/04/lifestyle-300x175.webp 300w, https://reactheme.com/news5/news-magazine/wp-content/uploads/sites/26/2025/04/lifestyle-1024x597.webp 1024w, https://reactheme.com/news5/news-magazine/wp-content/uploads/sites/26/2025/04/lifestyle-768x448.webp 768w, https://reactheme.com/news5/news-magazine/wp-content/uploads/sites/26/2025/04/lifestyle-600x350.webp 600w"
                                                    ...
                                                    <div class="post-item">
                                                        <div class="post-desc">
                                                            ...
                                                            <a
                                                                href="#">
                                                                How to Create a Balanced Lifestyle </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="show-featured clearfix">
                            ...
                            <div class="row child-cols col-match gx-4 gy-6">
                                    ...
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                <li><a href="{{ route('blogdetails') }}">Startups and technology</a></li>
                                                <li><a href="{{ route('blogdetails') }}">Data and security</a></li>
                                                <li><a href="{{ route('blogdetails') }}">Fintech and ecommerce</a></li>
                                                <li><a href="{{ route('blogdetails') }}">Investors and funding</a></li>
                                                <li><a href="{{ route('blogdetails') }}">Corporates and innovation</a></li>
                                                <li><a href="{{ route('blogdetails') }}">Government and policy</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 md:col">
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                <li><a href="{{ route('blogdetails') }}">Media</a></li>
                                                <li><a href="{{ route('blogdetails') }}">Events</a></li>
                                                <li><a href="{{ route('blogdetails') }}">Partner with us</a></li>
                                                <li><a href="{{ route('blogdetails') }}">Jobs</a></li>
                                                <li><a href="{{ route('blogdetails') }}">Masthead</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                ...
                                                <li><a href="{{ route('blogdetails') }}">Log in</a></li>
                                                <li><a href="{{ route('blogdetails') }}">Create an account</a></li>
                                ...
                                <div class="col-12 md:col-5">
                                    <div class="widget newsletter-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            ...
                                            <p class="fs-7 fw-medium text-dark dark:text-white text-opacity-50 mt-2">By pressing the Subscribe button, you confirm that you have read and are agreeing to our <a href="{{ route('blogdetails') }}" class="uc-link dark:text-white">Privacy Policy</a> and <a href="{{ route('blogdetails') }}" class="uc-link dark:text-white">Terms of Use</a></p>
                        ...
                        <div class="uc-footer-bottom panel vstack lg:hstack gap-4 justify-between fs-7 text-center lg:text-start">
                            <div class="vstack lg:hstack gap-2">
                                ...
                                <ul class="footer-site-links nav-x gap-2 fw-medium justify-center lg:justify-start">
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('blogdetails') }}">Privacy notice</a></li>
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('blogdetails') }}">Terms of condition</a></li>
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('blogdetails') }}">FAQ</a></li>
                                </ul>
                            </div>
