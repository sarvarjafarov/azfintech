        ...
        <div id="uc-search-modal" class="uc-modal-full uc-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog d-flex justify-center bg-white text-dark dark:bg-gray-900 dark:text-white" data-uc-height-viewport="">
                ...
                <div class="panel w-100 sm:w-500px px-2 py-10">
                    ...
                    <form class="hstack gap-1 mt-4 border-bottom p-narrow dark:border-gray-700" action="sign-in%EF%B9%96.html">
        ...
        <div id="uc-menu-panel" data-uc-offcanvas="overlay: true;">
            <div class="uc-offcanvas-bar bg-white text-dark dark:bg-gray-900 dark:text-white">
                <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                    <div class="uc-logo">
                        <a href="{{ route('signin') }}" class="h5 text-none text-gray-900 dark:text-white">
                    ...
                    <ul class="nav-y gap-narrow fw-bold fs-5" data-uc-nav>
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li><a href="{{ route('signin') }}">Main</a></li>
                                <li><a href="{{ route('signin') }}">Classic News</a></li>
                                <li><a href="{{ route('signin') }}">Tech</a></li>
                                <li><a href="{{ route('signin') }}">Classic Blog</a></li>
                                <li><a href="{{ route('signin') }}">Gaming</a></li>
                                <li><a href="{{ route('signin') }}">Sports</a></li>
                                <li><a href="{{ route('signin') }}">Newspaper</a></li>
                                <li><a href="{{ route('signin') }}">Magazine</a></li>
                                <li><a href="{{ route('signin') }}">Travel</a></li>
                                <li><a href="{{ route('signin') }}">Food</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('signin') }}">Blog</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('signin') }}">Full Width</a></li>
                                        <li><a href="{{ route('signin') }}">Grid 2 Cols</a></li>
                                        <li><a href="{{ route('signin') }}">Grid 3 Cols</a></li>
                                        <li><a href="{{ route('signin') }}">Grid 4 Cols</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="{{ route('signin') }}">Blog - detail</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('signin') }}">Blog detail</a></li>
                                        <li><a href="{{ route('signin') }}">Blog detail - v2</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Useful pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('signin') }}">Sign up</a></li>
                                        <li><a href="{{ route('signin') }}">Sign in</a></li>
                                        <li><a href="{{ route('signin') }}">Reset password</a></li>
                                        <li><a href="{{ route('signin') }}">404 page</a></li>
                                        <li><a href="{{ route('signin') }}">Coming soon</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Other pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('signin') }}">FAQ</a></li>
                                        <li><a href="{{ route('signin') }}">Terms of use</a></li>
                        ...
                        <li class="uc-parent">
                            <a href="{{ route('signin') }}">Shop</a>
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('signin') }}">Shop layouts</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('signin') }}">Shop 4 cols</a></li>
                                        <li><a href="{{ route('signin') }}">Shop 3 cols</a></li>
                                        <li><a href="{{ route('signin') }}">Shop 2 cols</a></li>
                                        <li><a href="{{ route('signin') }}">Shop with sidebar</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('signin') }}">Archive category</a></li>
                                <li><a href="{{ route('signin') }}">Product detail</a></li>
                                <li><a href="{{ route('signin') }}">Product detail - v2</a></li>
                                <li><a href="{{ route('signin') }}">Cart</a></li>
                                <li><a href="{{ route('signin') }}">Cart - v2</a></li>
                                <li><a href="{{ route('signin') }}">Checkout</a></li>
                                <li><a href="{{ route('signin') }}">Checkout - v2</a></li>
                                <li><a href="{{ route('signin') }}">Order confirmation</a></li>
                            </ul>
                        </li>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('signin') }}" class="position-cover" data-caption="Laptop Cover"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('signin') }}">Laptop Cover</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('signin') }}" class="position-cover" data-caption="Disney Toys"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('signin') }}">Disney Toys</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('signin') }}" class="position-cover" data-caption="Screen Axe"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('signin') }}">Screen Axe</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('signin') }}" class="position-cover" data-caption="Airpods Pro"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('signin') }}">Airpods Pro</a></h5>
                    ...
                    <div class="mini-cart-footer panel pt-3 border-top">
                        <div class="panel vstack gap-3 justify-between">
                            ...
                            <div class="mini-cart-actions vstack gap-1">
                                <a href="{{ route('signin') }}" class="btn btn-md btn-outline-gray-100 text-dark dark:text-white dark:border-gray-700 dark:hover:bg-gray-700">View cart</a>
                                <a href="{{ route('signin') }}" class="btn btn-md btn-primary text-white">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="panel vstack md:items-center justify-center h-screen overflow-hidden">
                                    <div data-anime="targets: >*; translateY: [-24, 0]; opacity: [0, 1]; easing: easeInOutCubic; duration: 750; delay: anime.stagger(100);">
                                        <div class="uc-logo cstack mx-auto mb-6 lg:mb-8">
                                            <a href="{{ route('signin') }}">
                                                <img class="w-100px lg:w-128px text-dark dark:text-white hover:text-primary transition-color duration-150 d-none dark:d-block" src="{{ asset('assets/images/demo-three/common/logo-dark.svg') }}" alt="Sign in">
                                                <img class="w-100px lg:w-128px text-dark dark:text-white hover:text-primary transition-color duration-150 d-block dark:d-none" src="{{ asset('assets/images/demo-three/common/logo-light.svg') }}" alt="Sign in">
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="panel vstack gap-3 w-100 sm:w-350px mx-auto text-center" data-anime="targets: >*; translateY: [24, 0]; opacity: [0, 1]; easing: easeInOutExpo; duration: 750; delay: anime.stagger(100);">
                                            ...
                                            <form class="vstack gap-2">
                                                ...
                                                <div class="hstack justify-between text-start">
                                                    ...
                                                    <a href="{{ route('signin') }}" class="uc-link fs-6">Forgot password</a>
                                                </div>
                                                <button class="btn btn-primary btn-sm mt-1" type="submit">Log in</button>
                                            </form>
                                            <p>Have no account yet? <a class="uc-link" href="{{ route('signin') }}">Sign up</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
