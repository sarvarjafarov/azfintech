...
@section('title', 'Blog - Grid 3 Cols - News5')
...
@section('content')
        ...
        <div id="uc-search-modal" class="uc-modal-full uc-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog d-flex justify-center bg-white text-dark dark:bg-gray-900 dark:text-white" data-uc-height-viewport="">
                ...
                <div class="panel w-100 sm:w-500px px-2 py-10">
                    ...
                    <form class="hstack gap-1 mt-4 border-bottom p-narrow dark:border-gray-700" action="blog-3cols%EF%B9%96.html">
        ...
        <div id="uc-menu-panel" data-uc-offcanvas="overlay: true;">
            <div class="uc-offcanvas-bar bg-white text-dark dark:bg-gray-900 dark:text-white">
                <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                    <div class="uc-logo">
                        <a href="{{ route('blog3cols') }}" class="h5 text-none text-gray-900 dark:text-white">
                    ...
                    <ul class="nav-y gap-narrow fw-bold fs-5" data-uc-nav>
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li><a href="{{ route('blog3cols') }}">Main</a></li>
                                <li><a href="{{ route('blog3cols') }}">Classic News</a></li>
                                <li><a href="{{ route('blog3cols') }}">Tech</a></li>
                                <li><a href="{{ route('blog3cols') }}">Classic Blog</a></li>
                                <li><a href="{{ route('blog3cols') }}">Gaming</a></li>
                                <li><a href="{{ route('blog3cols') }}">Sports</a></li>
                                <li><a href="{{ route('blog3cols') }}">Newspaper</a></li>
                                <li><a href="{{ route('blog3cols') }}">Magazine</a></li>
                                <li><a href="{{ route('blog3cols') }}">Travel</a></li>
                                <li><a href="{{ route('blog3cols') }}">Food</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('blog3cols') }}">Blog</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('blog3cols') }}">Full Width</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Grid 2 Cols</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Grid 3 Cols</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Grid 4 Cols</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="{{ route('blog3cols') }}">Blog - detail</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('blog3cols') }}">Blog detail</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Blog detail - v2</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Useful pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('blog3cols') }}">Sign up</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Sign in</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Reset password</a></li>
                                        <li><a href="{{ route('blog3cols') }}">404 page</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Coming soon</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Other pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('blog3cols') }}">FAQ</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Terms of use</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Privacy policy</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li class="uc-parent">
                            <a href="{{ route('blog3cols') }}">Shop</a>
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('blog3cols') }}">Shop layouts</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('blog3cols') }}">Shop 4 cols</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Shop 3 cols</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Shop 2 cols</a></li>
                                        <li><a href="{{ route('blog3cols') }}">Shop with sidebar</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('blog3cols') }}">Archive category</a></li>
                                <li><a href="{{ route('blog3cols') }}">Product detail</a></li>
                                <li><a href="{{ route('blog3cols') }}">Product detail - v2</a></li>
                                <li><a href="{{ route('blog3cols') }}">Cart</a></li>
                                <li><a href="{{ route('blog3cols') }}">Cart - v2</a></li>
                                <li><a href="{{ route('blog3cols') }}">Checkout</a></li>
                                <li><a href="{{ route('blog3cols') }}">Checkout - v2</a></li>
                                <li><a href="{{ route('blog3cols') }}">Order confirmation</a></li>
                            </ul>
                        </li>
                        <li class="hr opacity-10 my-1"></li>
                        <li><a href="{{ route('blog3cols') }}">Sign in</a></li>
                        <li><a href="{{ route('blog3cols') }}">Create an account</a></li>
                    </ul>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Laptop Cover"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('blog3cols') }}">Laptop Cover</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Disney Toys"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('blog3cols') }}">Disney Toys</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Screen Axe"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('blog3cols') }}">Screen Axe</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Airpods Pro"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('blog3cols') }}">Airpods Pro</a></h5>
                    ...
                    <div class="mini-cart-footer panel pt-3 border-top">
                        <div class="panel vstack gap-3 justify-between">
                            ...
                            <div class="mini-cart-actions vstack gap-1">
                                <a href="{{ route('blog3cols') }}" class="btn btn-md btn-outline-gray-100 text-dark dark:text-white dark:border-gray-700 dark:hover:bg-gray-700">View cart</a>
                                <a href="{{ route('blog3cols') }}" class="btn btn-md btn-primary text-white">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="uc-favorites-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog lg:max-w-500px bg-white text-dark dark:bg-gray-800 dark:text-white rounded">
                ...
                <div class="panel vstack justify-center items-center gap-2 text-center px-3 py-8">
                    ...
                    <a href="{{ route('blog3cols') }}" class="btn btn-sm btn-primary mt-2 uc-modal-close">Browse articles</a>
                </div>
            </div>
        </div>
        ...
        <div id="uc-gdpr-notification" class="uc-gdpr-notification uc-notification uc-notification-bottom-left lg:m-2">
            <div class="uc-notification-message">
                ...
                <p class="fs-7 mt-1 mb-2">We use cookies to ensure you get the best experience on our website. By continuing to use our site, you accept our use of cookies, <a href="{{ route('blog3cols') }}" class="uc-link text-underline">Privacy Policy</a>, and <a href="{{ route('blog3cols') }}" class="uc-link text-underline">Terms of Service</a>.</p>
                                            ...
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">The Rise of AI-Powered Personal Assistants: How They Manage</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Tech Innovations Reshaping the Retail Landscape: AI Payments</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Balancing Work and Wellness: Tech Solutions for Healthy</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">The Importance of Sleep: Tips for Better Rest and Recovery</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">The Future of Sustainable Living: Driving Eco-Friendly Lifestyles</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Business Agility the Digital Age: Leveraging AI and Automation</a>
                                                    </h6>
                                                </article>
                                            </div>
                                        </div>
                        ...
                        <div class="uc-navbar min-h-72px lg:min-h-80px text-gray-900 dark:text-white" data-uc-navbar=" animation: uc-animation-slide-top-small; duration: 150;">
                            <div class="uc-navbar-left">
                                ...
                                <ul class="uc-navbar-nav gap-3 ft-tertiary fs-5 fw-medium ms-4 d-none lg:d-flex" style="--uc-nav-height: 80px">
                                                            ...
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    <div class="post-media panel overflow-hidden">
                                                                        ...
                                                                        <a href="{{ route('blog3cols') }}" class="position-cover"></a>
                                                                    </div>
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blog3cols') }}">Tech</a>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">Business Agility the Digital Age: Leveraging AI and Automation</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blog3cols') }}">Network</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">The Art of Baking: From Classic Bread to Artisan Pastries</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blog3cols') }}">Virtual Reality</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">AI and Marketing: Unlocking Customer Insights</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blog3cols') }}">AI Powered</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">Hidden Gems: Underrated Travel Destinations Around the World</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blog3cols') }}">Gadgets</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">The Rise of AI-Powered Personal Assistants: How They Manage</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blog3cols') }}">Startups</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">Tech Innovations Reshaping the Retail Landscape: AI Payments</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">Balancing Work and Wellness: Tech Solutions for Healthy</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">The Importance of Sleep: Tips for Better Rest and Recovery</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blog3cols') }}">Travel</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">Solo Travel: Some Tips and Destinations for the Adventurous Explorer</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">AI-Powered Financial Planning: How Algorithms Revolutionizing</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">Tech Tools for your Time Management: Enhancing Productivity</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">A Guide to The Rise of Gourmet Street Food: Trends and Top Picks</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('blog3cols') }}">Trips</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">Eco-Tourism: Traveling Responsibly and Sustainably</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            ...
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('blog3cols') }}">The Future of Sustainable Living: Driving Eco-Friendly Lifestyles</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                    ...
                                    <li><a href="{{ route('blog3cols') }}">News</a></li>
                                    <li><a href="{{ route('blog3cols') }}">Tech</a></li>
                                    <li><a href="{{ route('blog3cols') }}">Sciense</a></li>
                                    <li>
                                                    ...
                                                    <div class="row child-cols g-4">
                                                        ...
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                                ...
                                                                <li><a href="{{ route('blog3cols') }}">Modern</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Classic</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Grid 2 cols</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Grid 3 cols</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Grid 4 cols</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Category</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Author</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Blog single</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Blog single v2</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Blog single v3</a></li>
                                                            </ul>
                                                        </div>
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                        ...
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                                ...
                                                                <li><a href="{{ route('blog3cols') }}">Sign up</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Reset password</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">404</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Coming Soon</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Terms of service</a></li>
                                                                <li><a href="{{ route('blog3cols') }}">Privacy policy</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
            ...
            <div class="breadcrumbs panel z-1 py-2 bg-gray-25 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white">
                <div class="container max-w-xl">
                    <ul class="breadcrumb nav-x justify-center gap-1 fs-7 sm:fs-6 m-0">
                        <li><a href="{{ route('blog3cols') }}">Home</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                        <li><a href="{{ route('blog3cols') }}">Blog</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Tech Innovations Reshaping the Retail Landscape: AI Payments"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Startups</a>
                                                    </div>
                                                                ...
                                                                <div class="hstack gap-2">
                                                                    <div>
                                                                        <div class="post-author hstack gap-1">
                                                                            <a href="{{ route('blog3cols') }}" data-uc-tooltip="Jason Blake"><img src="{{ asset('assets/images/avatars/05.png') }}" alt="Jason Blake" class="w-24px h-24px rounded-circle"></a>
                                                                            <a href="{{ route('blog3cols') }}" class="text-black dark:text-white text-none fw-bold">Jason Blake</a>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="post-date hstack gap-narrow">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Balancing Work and Wellness: Tech Solutions for Healthy"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Gadgets</a>
                                                    </div>
                                                    <div class="position-absolute top-0 end-0 w-150px h-150px rounded-top-end bg-gradient-45 from-transparent via-transparent to-black opacity-50"></div>
                                                    <span class="cstack position-absolute top-0 end-0 fs-6 w-40px h-40px text-white">
                                                        <i class="icon-narrow unicon-play-filled-alt"></i>
                                                        ...
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                                                <div class="hstack gap-2">
                                                                    <div>
                                                                        <div class="post-author hstack gap-1">
                                                                            <a href="{{ route('blog3cols') }}" data-uc-tooltip="Sarah Eddrissi"><img src="{{ asset('assets/images/avatars/03.png') }}" alt="Sarah Eddrissi" class="w-24px h-24px rounded-circle"></a>
                                                                            <a href="{{ route('blog3cols') }}" class="text-black dark:text-white text-none fw-bold">Sarah Eddrissi</a>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="post-date hstack gap-narrow">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="The Importance of Sleep: Tips for Better Rest and Recovery"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">AI Powered</a>
                                                    </div>
                                                    <div class="position-absolute top-0 end-0 w-150px h-150px rounded-top-end bg-gradient-45 from-transparent via-transparent to-black opacity-50"></div>
                                                    <span class="cstack position-absolute top-0 end-0 fs-6 w-40px h-40px text-white">
                                                        <i class="icon-narrow unicon-play-filled-alt"></i>
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="The Future of Sustainable Living: Driving Eco-Friendly Lifestyles"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">AI Powered</a>
                                                    </div>
                                                        ...
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                                                <div class="hstack gap-2">
                                                                    <div>
                                                                        <div class="post-author hstack gap-1">
                                                                            <a href="{{ route('blog3cols') }}" data-uc-tooltip="Anna Luis"><img src="{{ asset('assets/images/avatars/04.png') }}" alt="Anna Luis" class="w-24px h-24px rounded-circle"></a>
                                                                            <a href="{{ route('blog3cols') }}" class="text-black dark:text-white text-none fw-bold">Anna Luis</a>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="post-date hstack gap-narrow">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Business Agility the Digital Age: Leveraging AI and Automation"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Tech</a>
                                                    </div>
                                                    <div class="position-absolute top-0 end-0 w-150px h-150px rounded-top-end bg-gradient-45 from-transparent via-transparent to-black opacity-50"></div>
                                                    <span class="cstack position-absolute top-0 end-0 fs-6 w-40px h-40px text-white">
                                                        <i class="icon-narrow unicon-play-filled-alt"></i>
                                                        ...
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                                                <div class="hstack gap-2">
                                                                    <div>
                                                                        <div class="post-author hstack gap-1">
                                                                            <a href="{{ route('blog3cols') }}" data-uc-tooltip="Nisi Nyung"><img src="{{ asset('assets/images/avatars/08.png') }}" alt="Nisi Nyung" class="w-24px h-24px rounded-circle"></a>
                                                                            <a href="{{ route('blog3cols') }}" class="text-black dark:text-white text-none fw-bold">Nisi Nyung</a>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="post-date hstack gap-narrow">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="The Art of Baking: From Classic Bread to Artisan Pastries"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Network</a>
                                                    </div>
                                                    <div class="position-absolute top-0 end-0 w-150px h-150px rounded-top-end bg-gradient-45 from-transparent via-transparent to-black opacity-50"></div>
                                                    <span class="cstack position-absolute top-0 end-0 fs-6 w-40px h-40px text-white">
                                                        <i class="icon-narrow unicon-play-filled-alt"></i>
                                                ...
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">The Art of Baking: From Classic Bread to Artisan Pastries</a>
                                                    </h3>
                                                    <div>
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="AI and Marketing: Unlocking Customer Insights"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Virtual Reality</a>
                                                    </div>
                                                </div>
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">AI and Marketing: Unlocking Customer Insights</a>
                                                    </h3>
                                                    <div>
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                                                <div class="hstack gap-2">
                                                                    <div>
                                                                        <div class="post-author hstack gap-1">
                                                                            <a href="{{ route('blog3cols') }}" data-uc-tooltip="Rico Santos"><img src="{{ asset('assets/images/avatars/07.png') }}" alt="Rico Santos" class="w-24px h-24px rounded-circle"></a>
                                                                            <a href="{{ route('blog3cols') }}" class="text-black dark:text-white text-none fw-bold">Rico Santos</a>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="post-date hstack gap-narrow">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Hidden Gems: Underrated Travel Destinations Around the World"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">AI Powered</a>
                                                    </div>
                                                ...
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Hidden Gems: Underrated Travel Destinations Around the World</a>
                                                    </h3>
                                                    <div>
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                                                <div class="hstack gap-2">
                                                                    <div>
                                                                        <div class="post-author hstack gap-1">
                                                                            <a href="{{ route('blog3cols') }}" data-uc-tooltip="David Peterson"><img src="{{ asset('assets/images/avatars/01.png') }}" alt="David Peterson" class="w-24px h-24px rounded-circle"></a>
                                                                            <a href="{{ route('blog3cols') }}" class="text-black dark:text-white text-none fw-bold">David Peterson</a>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="post-date hstack gap-narrow">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Eco-Tourism: Traveling Responsibly and Sustainably"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Trips</a>
                                                    </div>
                                                </div>
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Eco-Tourism: Traveling Responsibly and Sustainably</a>
                                                    </h3>
                                                    <div>
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Solo Travel: Some Tips and Destinations for the Adventurous Explorer"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Travel</a>
                                                    </div>
                                                </div>
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Solo Travel: Some Tips and Destinations for the Adventurous Explorer</a>
                                                    </h3>
                                                    <div>
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                                                <div class="hstack gap-2">
                                                                    <div>
                                                                        <div class="post-author hstack gap-1">
                                                                            <a href="{{ route('blog3cols') }}" data-uc-tooltip="Peter Sawyer"><img src="{{ asset('assets/images/avatars/02.png') }}" alt="Peter Sawyer" class="w-24px h-24px rounded-circle"></a>
                                                                            <a href="{{ route('blog3cols') }}" class="text-black dark:text-white text-none fw-bold">Peter Sawyer</a>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="post-date hstack gap-narrow">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="AI-Powered Financial Planning: How Algorithms Revolutionizing"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Tech</a>
                                                    </div>
                                                ...
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">AI-Powered Financial Planning: How Algorithms Revolutionizing</a>
                                                    </h3>
                                                    <div>
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Tech Tools for your Time Management: Enhancing Productivity"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Startups</a>
                                                    </div>
                                                ...
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Tech Tools for your Time Management: Enhancing Productivity</a>
                                                    </h3>
                                                    <div>
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="A Guide to The Rise of Gourmet Street Food: Trends and Top Picks"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">AI Powered</a>
                                                    </div>
                                                ...
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">A Guide to The Rise of Gourmet Street Food: Trends and Top Picks</a>
                                                    </h3>
                                                    <div>
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Gaming in the Age of AI: Strategies for Startups"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Virtual Reality</a>
                                                    </div>
                                                ...
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Gaming in the Age of AI: Strategies for Startups</a>
                                                    </h3>
                                                    <div>
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('blog3cols') }}" class="position-cover" data-caption="Top Independent Contractors to Invest in Best of Startups"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Media</a>
                                                    </div>
                                                </div>
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="{{ route('blog3cols') }}">Top Independent Contractors to Invest in Best of Startups</a>
                                                    </h3>
                                                    <div>
                                                        <div class="post-meta panel hstack justify-center fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            <div class="meta">
                            ...
                            <div class="row child-cols col-match gx-4 gy-6">
                                    ...
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                <li><a href="{{ route('blog3cols') }}">Startups and technology</a></li>
                                                <li><a href="{{ route('blog3cols') }}">Data and security</a></li>
                                                <li><a href="{{ route('blog3cols') }}">Fintech and ecommerce</a></li>
                                                <li><a href="{{ route('blog3cols') }}">Investors and funding</a></li>
                                                <li><a href="{{ route('blog3cols') }}">Corporates and innovation</a></li>
                                                <li><a href="{{ route('blog3cols') }}">Government and policy</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 md:col">
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                <li><a href="{{ route('blog3cols') }}">Media</a></li>
                                                <li><a href="{{ route('blog3cols') }}">Events</a></li>
                                                <li><a href="{{ route('blog3cols') }}">Partner with us</a></li>
                                                <li><a href="{{ route('blog3cols') }}">Jobs</a></li>
                                                <li><a href="{{ route('blog3cols') }}">Masthead</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                ...
                                                <li><a href="{{ route('blog3cols') }}">Log in</a></li>
                                                <li><a href="{{ route('blog3cols') }}">Create an account</a></li>
                                ...
                                <div class="col-12 md:col-5">
                                    <div class="widget newsletter-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            ...
                                            <p class="fs-7 fw-medium text-dark dark:text-white text-opacity-50 mt-2">By pressing the Subscribe button, you confirm that you have read and are agreeing to our <a href="{{ route('blog3cols') }}" class="uc-link dark:text-white">Privacy Policy</a> and <a href="{{ route('blog3cols') }}" class="uc-link dark:text-white">Terms of Use</a></p>
                        ...
                        <div class="uc-footer-bottom panel vstack lg:hstack gap-4 justify-between fs-7 text-center lg:text-start">
                            <div class="vstack lg:hstack gap-2">
                                ...
                                <ul class="footer-site-links nav-x gap-2 fw-medium justify-center lg:justify-start">
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('blog3cols') }}">Privacy notice</a></li>
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('blog3cols') }}">Terms of condition</a></li>
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('blog3cols') }}">FAQ</a></li>
                                </ul>
                            </div>
