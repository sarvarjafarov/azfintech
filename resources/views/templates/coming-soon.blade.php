        ...
        <div id="uc-search-modal" class="uc-modal-full uc-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog d-flex justify-center bg-white text-dark dark:bg-gray-900 dark:text-white" data-uc-height-viewport="">
                ...
                <div class="panel w-100 sm:w-500px px-2 py-10">
                    ...
                    <form class="hstack gap-1 mt-4 border-bottom p-narrow dark:border-gray-700" action="coming-soon%EF%B9%96.html">
        ...
        <div id="uc-menu-panel" data-uc-offcanvas="overlay: true;">
            <div class="uc-offcanvas-bar bg-white text-dark dark:bg-gray-900 dark:text-white">
                <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                    <div class="uc-logo">
                        <a href="{{ route('comingsoon') }}" class="h5 text-none text-gray-900 dark:text-white">
                    ...
                    <ul class="nav-y gap-narrow fw-bold fs-5" data-uc-nav>
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li><a href="{{ route('comingsoon') }}">Main</a></li>
                                <li><a href="{{ route('comingsoon') }}">Classic News</a></li>
                                <li><a href="{{ route('comingsoon') }}">Tech</a></li>
                                <li><a href="{{ route('comingsoon') }}">Classic Blog</a></li>
                                <li><a href="{{ route('comingsoon') }}">Gaming</a></li>
                                <li><a href="{{ route('comingsoon') }}">Sports</a></li>
                                <li><a href="{{ route('comingsoon') }}">Newspaper</a></li>
                                <li><a href="{{ route('comingsoon') }}">Magazine</a></li>
                                <li><a href="{{ route('comingsoon') }}">Travel</a></li>
                                <li><a href="{{ route('comingsoon') }}">Food</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    ...
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('comingsoon') }}">Full Width</a></li>
                                        <li><a href="{{ route('comingsoon') }}">Grid 2 Cols</a></li>
                                        <li><a href="{{ route('comingsoon') }}">Grid 3 Cols</a></li>
                                        <li><a href="{{ route('comingsoon') }}">Grid 4 Cols</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="{{ route('comingsoon') }}">Blog - detail</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('comingsoon') }}">Blog detail</a></li>
                                        <li><a href="{{ route('comingsoon') }}">Blog detail - v2</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Useful pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('comingsoon') }}">Sign up</a></li>
                                        <li><a href="{{ route('comingsoon') }}">Sign in</a></li>
                                        <li><a href="{{ route('comingsoon') }}">Reset password</a></li>
                                        <li><a href="{{ route('comingsoon') }}">404 page</a></li>
                                ...
                                <li class="uc-parent">
                                    ...
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('comingsoon') }}">FAQ</a></li>
                        ...
                        <li class="uc-parent">
                            <a href="{{ route('comingsoon') }}">Shop</a>
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('comingsoon') }}">Shop layouts</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('comingsoon') }}">Shop 4 cols</a></li>
                                        <li><a href="{{ route('comingsoon') }}">Shop 3 cols</a></li>
                                        <li><a href="{{ route('comingsoon') }}">Shop 2 cols</a></li>
                                        <li><a href="{{ route('comingsoon') }}">Shop with sidebar</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('comingsoon') }}">Archive category</a></li>
                                <li><a href="{{ route('comingsoon') }}">Product detail</a></li>
                                <li><a href="{{ route('comingsoon') }}">Product detail - v2</a></li>
                                <li><a href="{{ route('comingsoon') }}">Cart</a></li>
                                <li><a href="{{ route('comingsoon') }}">Cart - v2</a></li>
                                <li><a href="{{ route('comingsoon') }}">Checkout</a></li>
                                <li><a href="{{ route('comingsoon') }}">Checkout - v2</a></li>
                                <li><a href="{{ route('comingsoon') }}">Order confirmation</a></li>
                            </ul>
                        </li>
                        <li class="hr opacity-10 my-1"></li>
                        <li><a href="{{ route('comingsoon') }}">Sign in</a></li>
                        <li><a href="{{ route('comingsoon') }}">Create an account</a></li>
                    </ul>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('comingsoon') }}" class="position-cover" data-caption="Laptop Cover"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('comingsoon') }}">Laptop Cover</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('comingsoon') }}" class="position-cover" data-caption="Disney Toys"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('comingsoon') }}">Disney Toys</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('comingsoon') }}" class="position-cover" data-caption="Screen Axe"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('comingsoon') }}">Screen Axe</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('comingsoon') }}" class="position-cover" data-caption="Airpods Pro"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('comingsoon') }}">Airpods Pro</a></h5>
                    ...
                    <div class="mini-cart-footer panel pt-3 border-top">
                        <div class="panel vstack gap-3 justify-between">
                            ...
                            <div class="mini-cart-actions vstack gap-1">
                                <a href="{{ route('comingsoon') }}" class="btn btn-md btn-outline-gray-100 text-dark dark:text-white dark:border-gray-700 dark:hover:bg-gray-700">View cart</a>
                                <a href="{{ route('comingsoon') }}" class="btn btn-md btn-primary text-white">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="section bg-white dark:bg-gray-900 text-dark dark:text-white">
                <div class="container max-w-xl">
                    <div class="panel vstack justify-center items-center gap-2 sm:gap-4 lg:gap-8 text-center h-screen">
                        ...
                        <div class="row child-cols-3 items-center justify-center g-1 sm:g-2" data-uc-countdown="date: <script>
                                document.write(
                                    new Date().getFullYear()
                                )
                            </script>-09-12T16:09:10+00:00">
                            <div>
                                <div>
