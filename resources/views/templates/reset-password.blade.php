        ...
        <div id="uc-search-modal" class="uc-modal-full uc-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog d-flex justify-center bg-white text-dark dark:bg-gray-900 dark:text-white" data-uc-height-viewport="">
                ...
                <div class="panel w-100 sm:w-500px px-2 py-10">
                    ...
                    <form class="hstack gap-1 mt-4 border-bottom p-narrow dark:border-gray-700" action="reset-password%EF%B9%96.html">
        ...
        <div id="uc-menu-panel" data-uc-offcanvas="overlay: true;">
            <div class="uc-offcanvas-bar bg-white text-dark dark:bg-gray-900 dark:text-white">
                <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                    <div class="uc-logo">
                        <a href="{{ route('resetpassword') }}" class="h5 text-none text-gray-900 dark:text-white">
                    ...
                    <ul class="nav-y gap-narrow fw-bold fs-5" data-uc-nav>
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li><a href="{{ route('resetpassword') }}">Main</a></li>
                                <li><a href="{{ route('resetpassword') }}">Classic News</a></li>
                                <li><a href="{{ route('resetpassword') }}">Tech</a></li>
                                <li><a href="{{ route('resetpassword') }}">Classic Blog</a></li>
                                <li><a href="{{ route('resetpassword') }}">Gaming</a></li>
                                <li><a href="{{ route('resetpassword') }}">Sports</a></li>
                                <li><a href="{{ route('resetpassword') }}">Newspaper</a></li>
                                <li><a href="{{ route('resetpassword') }}">Magazine</a></li>
                                <li><a href="{{ route('resetpassword') }}">Travel</a></li>
                                <li><a href="{{ route('resetpassword') }}">Food</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('resetpassword') }}">Blog</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('resetpassword') }}">Full Width</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Grid 2 Cols</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Grid 3 Cols</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Grid 4 Cols</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="{{ route('resetpassword') }}">Blog - detail</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('resetpassword') }}">Blog detail</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Blog detail - v2</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Useful pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('resetpassword') }}">Sign up</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Sign in</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Reset password</a></li>
                                        <li><a href="{{ route('resetpassword') }}">404 page</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Coming soon</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Other pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('resetpassword') }}">FAQ</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Terms of use</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Privacy policy</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li class="uc-parent">
                            <a href="{{ route('resetpassword') }}">Shop</a>
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('resetpassword') }}">Shop layouts</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('resetpassword') }}">Shop 4 cols</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Shop 3 cols</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Shop 2 cols</a></li>
                                        <li><a href="{{ route('resetpassword') }}">Shop with sidebar</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('resetpassword') }}">Archive category</a></li>
                                <li><a href="{{ route('resetpassword') }}">Product detail</a></li>
                                <li><a href="{{ route('resetpassword') }}">Product detail - v2</a></li>
                                <li><a href="{{ route('resetpassword') }}">Cart</a></li>
                                <li><a href="{{ route('resetpassword') }}">Cart - v2</a></li>
                                <li><a href="{{ route('resetpassword') }}">Checkout</a></li>
                                <li><a href="{{ route('resetpassword') }}">Checkout - v2</a></li>
                                <li><a href="{{ route('resetpassword') }}">Order confirmation</a></li>
                            </ul>
                        </li>
                        <li class="hr opacity-10 my-1"></li>
                        <li><a href="{{ route('resetpassword') }}">Sign in</a></li>
                        <li><a href="{{ route('resetpassword') }}">Create an account</a></li>
                    </ul>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('resetpassword') }}" class="position-cover" data-caption="Laptop Cover"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('resetpassword') }}">Laptop Cover</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('resetpassword') }}" class="position-cover" data-caption="Disney Toys"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('resetpassword') }}">Disney Toys</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('resetpassword') }}" class="position-cover" data-caption="Screen Axe"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('resetpassword') }}">Screen Axe</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('resetpassword') }}" class="position-cover" data-caption="Airpods Pro"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('resetpassword') }}">Airpods Pro</a></h5>
                    ...
                    <div class="mini-cart-footer panel pt-3 border-top">
                        <div class="panel vstack gap-3 justify-between">
                            ...
                            <div class="mini-cart-actions vstack gap-1">
                                <a href="{{ route('resetpassword') }}" class="btn btn-md btn-outline-gray-100 text-dark dark:text-white dark:border-gray-700 dark:hover:bg-gray-700">View cart</a>
                                <a href="{{ route('resetpassword') }}" class="btn btn-md btn-primary text-white">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row child-cols-12 lg:child-cols-6 g-0" data-uc-grid>
                            <div class="d-none lg:d-block">
                                <figure class="panel h-100 m-0 bg-gray-25 dark:bg-gray-900 bg-gray-25 dark:bg-gray-800">
                                    ...
                                    <img class="media-cover image" src="{{ asset('assets/images/common/img-fallback.png') }}" data-src="{{ asset('assets/images/demo-three/common/my-account.jpg') }}" alt="My account" data-uc-img="loading: lazy">
                                </figure>
                            </div>
                            <div>
                                <div class="panel vstack md:items-center justify-center h-screen overflow-hidden">
                                    <div data-anime="targets: >*; translateY: [-24, 0]; opacity: [0, 1]; easing: easeInOutCubic; duration: 750; delay: anime.stagger(100);">
                                        <div class="uc-logo cstack mx-auto mb-6 lg:mb-8">
                                            <a href="{{ route('resetpassword') }}">
                                                <img class="w-100px lg:w-128px text-dark dark:text-white hover:text-primary transition-color duration-150 d-none dark:d-block" src="{{ asset('assets/images/demo-three/common/logo-dark.svg') }}" alt="Reset password">
                                                <img class="w-100px lg:w-128px text-dark dark:text-white hover:text-primary transition-color duration-150 d-block dark:d-none" src="{{ asset('assets/images/demo-three/common/logo-light.svg') }}" alt="Reset password">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="panel py-4 px-2">
                                        <div class="panel vstack gap-3 w-100 sm:w-350px mx-auto text-center" data-anime="targets: >*; translateY: [24, 0]; opacity: [0, 1]; easing: easeInOutCubic; duration: 750; delay: anime.stagger(100);">
                                            ...
                                            <p class="mt-2 sm:m-0">Remember your password? <a class="uc-link" href="{{ route('resetpassword') }}">Sign in</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
