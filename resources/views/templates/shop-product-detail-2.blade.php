...
@section('content')
        ...
        <div id="uc-search-modal" class="uc-modal-full uc-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog d-flex justify-center bg-white text-dark dark:bg-gray-900 dark:text-white" data-uc-height-viewport="">
                ...
                <div class="panel w-100 sm:w-500px px-2 py-10">
                    ...
                    <form class="hstack gap-1 mt-4 border-bottom p-narrow dark:border-gray-700" action="shop-product-detail-2%EF%B9%96.html">
        ...
        <div id="uc-menu-panel" data-uc-offcanvas="overlay: true;">
            <div class="uc-offcanvas-bar bg-white text-dark dark:bg-gray-900 dark:text-white">
                <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                    <div class="uc-logo">
                        <a href="{{ route('shopproductdetail2') }}" class="h5 text-none text-gray-900 dark:text-white">
                    ...
                    <ul class="nav-y gap-narrow fw-bold fs-5" data-uc-nav>
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li><a href="{{ route('shopproductdetail2') }}">Main</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Classic News</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Tech</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Classic Blog</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Gaming</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Sports</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Newspaper</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Magazine</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Travel</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Food</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('shopproductdetail2') }}">Blog</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('shopproductdetail2') }}">Full Width</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Grid 2 Cols</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Grid 3 Cols</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Grid 4 Cols</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="{{ route('shopproductdetail2') }}">Blog - detail</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('shopproductdetail2') }}">Blog detail</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Blog detail - v2</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Useful pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('shopproductdetail2') }}">Sign up</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Sign in</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Reset password</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">404 page</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Coming soon</a></li>
                                    </ul>
                                </li>
                                <li class="uc-parent">
                                    <a href="#">Other pages</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('shopproductdetail2') }}">FAQ</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Terms of use</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Privacy policy</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li class="uc-parent">
                            <a href="{{ route('shopproductdetail2') }}">Shop</a>
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    <a href="{{ route('shopproductdetail2') }}">Shop layouts</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="{{ route('shopproductdetail2') }}">Shop 4 cols</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Shop 3 cols</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Shop 2 cols</a></li>
                                        <li><a href="{{ route('shopproductdetail2') }}">Shop with sidebar</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('shopproductdetail2') }}">Archive category</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Product detail</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Product detail - v2</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Cart</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Cart - v2</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Checkout</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Checkout - v2</a></li>
                                <li><a href="{{ route('shopproductdetail2') }}">Order confirmation</a></li>
                            </ul>
                        </li>
                        <li class="hr opacity-10 my-1"></li>
                        <li><a href="{{ route('shopproductdetail2') }}">Sign in</a></li>
                        <li><a href="{{ route('shopproductdetail2') }}">Create an account</a></li>
                    </ul>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('shopproductdetail2') }}" class="position-cover" data-caption="Laptop Cover"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('shopproductdetail2') }}">Laptop Cover</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('shopproductdetail2') }}" class="position-cover" data-caption="Disney Toys"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('shopproductdetail2') }}">Disney Toys</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('shopproductdetail2') }}" class="position-cover" data-caption="Screen Axe"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('shopproductdetail2') }}">Screen Axe</a></h5>
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            ...
                                            <a href="{{ route('shopproductdetail2') }}" class="position-cover" data-caption="Airpods Pro"></a>
                                        </figure>
                                        <div class="content vstack gap-narrow fs-6">
                                            <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white" href="{{ route('shopproductdetail2') }}">Airpods Pro</a></h5>
                    ...
                    <div class="mini-cart-footer panel pt-3 border-top">
                        <div class="panel vstack gap-3 justify-between">
                            ...
                            <div class="mini-cart-actions vstack gap-1">
                                <a href="{{ route('shopproductdetail2') }}" class="btn btn-md btn-outline-gray-100 text-dark dark:text-white dark:border-gray-700 dark:hover:bg-gray-700">View cart</a>
                                <a href="{{ route('shopproductdetail2') }}" class="btn btn-md btn-primary text-white">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="uc-favorites-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog lg:max-w-500px bg-white text-dark dark:bg-gray-800 dark:text-white rounded">
                ...
                <div class="panel vstack justify-center items-center gap-2 text-center px-3 py-8">
                    ...
                    <a href="{{ route('shopproductdetail2') }}" class="btn btn-sm btn-primary mt-2 uc-modal-close">Browse articles</a>
                </div>
            </div>
        </div>
        ...
        <div id="uc-gdpr-notification" class="uc-gdpr-notification uc-notification uc-notification-bottom-left lg:m-2">
            <div class="uc-notification-message">
                ...
                <p class="fs-7 mt-1 mb-2">We use cookies to ensure you get the best experience on our website. By continuing to use our site, you accept our use of cookies, <a href="{{ route('shopproductdetail2') }}" class="uc-link text-underline">Privacy Policy</a>, and <a href="{{ route('shopproductdetail2') }}" class="uc-link text-underline">Terms of Service</a>.</p>
                                            ...
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail2') }}">The Rise of AI-Powered Personal Assistants: How They Manage</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail2') }}">Tech Innovations Reshaping the Retail Landscape: AI Payments</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail2') }}">Balancing Work and Wellness: Tech Solutions for Healthy</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail2') }}">The Importance of Sleep: Tips for Better Rest and Recovery</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail2') }}">The Future of Sustainable Living: Driving Eco-Friendly Lifestyles</a>
                                                    </h6>
                                                </article>
                                            </div>
                                            <div class="swiper-slide">
                                                <article class="post type-post">
                                                    <h6 class="post-title fs-6 ft-primary fw-medium m-0 opacity-75 dark:text-white" data-swiper-parallax-y="-24">
                                                        <a class="text-none" href="{{ route('shopproductdetail2') }}">Business Agility the Digital Age: Leveraging AI and Automation</a>
                                                    </h6>
                                                </article>
                                            </div>
                                        </div>
                        ...
                        <div class="uc-navbar min-h-72px lg:min-h-80px text-gray-900 dark:text-white" data-uc-navbar=" animation: uc-animation-slide-top-small; duration: 150;">
                            <div class="uc-navbar-left">
                                ...
                                <div class="uc-logo d-none md:d-block text-dark dark:text-white">
                                    <a href="{{ route('shopproductdetail2') }}">
                                ...
                                <ul class="uc-navbar-nav gap-3 ft-tertiary fs-5 fw-medium ms-4 d-none lg:d-flex" style="--uc-nav-height: 80px">
                                                            ...
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    <div class="post-media panel overflow-hidden">
                                                                        ...
                                                                        <a href="{{ route('shopproductdetail2') }}" class="position-cover"></a>
                                                                    </div>
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail2') }}">Tech</a>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">Business Agility the Digital Age: Leveraging AI and Automation</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail2') }}">Network</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">The Art of Baking: From Classic Bread to Artisan Pastries</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail2') }}">Virtual Reality</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">AI and Marketing: Unlocking Customer Insights</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail2') }}">AI Powered</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">Hidden Gems: Underrated Travel Destinations Around the World</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail2') }}">Gadgets</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">The Rise of AI-Powered Personal Assistants: How They Manage</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail2') }}">Startups</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">Tech Innovations Reshaping the Retail Landscape: AI Payments</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">Balancing Work and Wellness: Tech Solutions for Healthy</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">The Importance of Sleep: Tips for Better Rest and Recovery</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail2') }}">Travel</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">Solo Travel: Some Tips and Destinations for the Adventurous Explorer</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">AI-Powered Financial Planning: How Algorithms Revolutionizing</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">Tech Tools for your Time Management: Enhancing Productivity</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">A Guide to The Rise of Gourmet Street Food: Trends and Top Picks</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                                ...
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                            <div>
                                                                                <div class="post-category hstack gap-narrow fw-semibold">
                                                                                    <a class="fw-medium text-none text-primary dark:text-primary-400" href="{{ route('shopproductdetail2') }}">Trips</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sep d-none md:d-block">|</div>
                                                                            <div class="d-none md:d-block">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">Eco-Tourism: Traveling Responsibly and Sustainably</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                                            ...
                                                            <div>
                                                                <article class="post type-post panel vstack gap-1">
                                                                    ...
                                                                    <div class="post-header panel vstack gap-narrow">
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('shopproductdetail2') }}">The Future of Sustainable Living: Driving Eco-Friendly Lifestyles</a>
                                                                        </h3>
                                                                    </div>
                                                                </article>
                                                            </div>
                                    ...
                                    <li><a href="{{ route('shopproductdetail2') }}">News</a></li>
                                    <li><a href="{{ route('shopproductdetail2') }}">Tech</a></li>
                                    <li><a href="{{ route('shopproductdetail2') }}">Sciense</a></li>
                                    <li>
                                                    ...
                                                    <div class="row child-cols g-4">
                                                        ...
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                                ...
                                                                <li><a href="{{ route('shopproductdetail2') }}">Modern</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Classic</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Grid 2 cols</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Grid 3 cols</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Grid 4 cols</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Category</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Author</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Blog single</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Blog single v2</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Blog single v3</a></li>
                                                            </ul>
                                                        </div>
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                        ...
                                                        <div>
                                                            <ul class="uc-nav uc-navbar-dropdown-nav">
                                                                ...
                                                                <li><a href="{{ route('shopproductdetail2') }}">Sign up</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Reset password</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">404</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Coming Soon</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Terms of service</a></li>
                                                                <li><a href="{{ route('shopproductdetail2') }}">Privacy policy</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
            ...
            <div class="breadcrumbs panel z-1 py-2 bg-gray-25 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white">
                <div class="container max-w-xl">
                    <ul class="breadcrumb nav-x justify-center gap-1 fs-7 sm:fs-6 m-0">
                        <li><a href="{{ route('shopproductdetail2') }}">Home</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                        <li><a href="{{ route('shopproductdetail2') }}">Shop</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                        <li><a href="{{ route('shopproductdetail2') }}">Toys</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                ...
                <div class="container max-w-xl">
                    <div class="product-header panel">
                        <div class="row child-cols-12 lg:child-cols-6 gy-4 gx-4 md:gx-6 xl:gx-8">
                            ...
                            <div>
                                <div class="product-details panel vstack justify-center items-center gap-1 xl:gap-2 max-w-500px mx-auto text-center" data-uc-sticky="bottom: true; offset: 48;">
                                    ...
                                    <p class="product-desc fs-6 xl:fs-5 my-2">Consetetur sadipscing elitr, syosma vero eos et accusam et justo takimata sit amet sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
                                    <form class="product-actions hstack justify-center gap-1 xl:mt-2">
                                        <button type="submit" class="btn btn-sm lg:btn-md btn-primary md:max-w-150px flex-1">Buy now</button>
                                    </form>
                                    <ul class="nav-x mt-2 xl:mt-4 ft-secondary">
                                        ...
                                        <li class="hstack gap-narrow">
                                            ...
                                            <a class="text-primary" href="{{ route('shopproductdetail2') }}">Toys</a>,
                                            <a class="text-primary" href="{{ route('shopproductdetail2') }}">Games</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="product-tabs-content uc-switcher mt-4 max-w-sm mx-auto">
                            <div>
                                <div id="product-details" class="product-details panel py-2 lg:py-4" data-uc-lightbox="">
                                    ...
                                    <p>Aliquid iusto dolores laudantium commodi ut ullam id, numquam repellat quo maiores excepturi cum atque consequuntur alias sunt, dignissimos architecto odio unde!</p>
                                </div>
                            </div>
                            <div>
                                    ...
                                    new Date().getFullYear()
                                        ...
                                        <div>
                                            <div class="panel vstack gap-1 lg:gap-2" data-uc-sticky="bottom: true; offset: 40;">
                                                ...
                                                <form class="panel vstack gap-2 lg:gap-3 mt-2" action="shop-product-detail-2%EF%B9%96.html">
                                            ...
                                            <div class="vstack gap-2">
                                                <div class="panel">
                                                    <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('shopproductdetail2') }}" class="position-cover" data-caption="Elegant Watch"></a>
                                                    </figure>
                                                ...
                                                <div class="content vstack items-center gap-1 fs-6 text-center xl:mt-1">
                                                    <h5 class="h6 lg:h5 m-0"><a class="text-none" href="{{ route('shopproductdetail2') }}">Elegant Watch</a></h5>
                                                    <ul class="nav-x gap-0 text-gray-100 dark:text-gray-700" title="Average 5 out of 5">
                                            ...
                                            <div class="vstack gap-2">
                                                <div class="panel">
                                                    <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('shopproductdetail2') }}" class="position-cover" data-caption="Hemp Seed"></a>
                                                    </figure>
                                                </div>
                                                <div class="content vstack items-center gap-1 fs-6 text-center xl:mt-1">
                                                    <h5 class="h6 lg:h5 m-0"><a class="text-none" href="{{ route('shopproductdetail2') }}">Hemp Seed</a></h5>
                                                    <ul class="nav-x gap-0 text-gray-100 dark:text-gray-700" title="Average 4 out of 5">
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                            ...
                                            <div class="vstack gap-2">
                                                <div class="panel">
                                                    <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('shopproductdetail2') }}" class="position-cover" data-caption="White Classic Watch"></a>
                                                    </figure>
                                                ...
                                                <div class="content vstack items-center gap-1 fs-6 text-center xl:mt-1">
                                                    <h5 class="h6 lg:h5 m-0"><a class="text-none" href="{{ route('shopproductdetail2') }}">White Classic Watch</a></h5>
                                                    <ul class="nav-x gap-0 text-gray-100 dark:text-gray-700" title="Average 5 out of 5">
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                            ...
                                            <div class="vstack gap-2">
                                                <div class="panel">
                                                    <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('shopproductdetail2') }}" class="position-cover" data-caption="Stylish Starbucks"></a>
                                                    </figure>
                                                </div>
                                                <div class="content vstack items-center gap-1 fs-6 text-center xl:mt-1">
                                                    <h5 class="h6 lg:h5 m-0"><a class="text-none" href="{{ route('shopproductdetail2') }}">Stylish Starbucks</a></h5>
                                                    <ul class="nav-x gap-0 text-gray-100 dark:text-gray-700" title="Average 5 out of 5">
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                                        <li><i class="icon fs-7 unicon-star-filled text-yellow"></i></li>
                                            ...
                                            <div class="vstack gap-2">
                                                <div class="panel">
                                                    <figure class="featured-image m-0 ratio ratio-1x1 uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="{{ route('shopproductdetail2') }}" class="position-cover" data-caption="Black AirTag"></a>
                                                    </figure>
                                                </div>
                                                <div class="content vstack items-center gap-1 fs-6 text-center xl:mt-1">
                                                    <h5 class="h6 lg:h5 m-0"><a class="text-none" href="{{ route('shopproductdetail2') }}">Black AirTag</a></h5>
                            ...
                            <div class="row child-cols col-match gx-4 gy-6">
                                    ...
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                <li><a href="{{ route('shopproductdetail2') }}">Startups and technology</a></li>
                                                <li><a href="{{ route('shopproductdetail2') }}">Data and security</a></li>
                                                <li><a href="{{ route('shopproductdetail2') }}">Fintech and ecommerce</a></li>
                                                <li><a href="{{ route('shopproductdetail2') }}">Investors and funding</a></li>
                                                <li><a href="{{ route('shopproductdetail2') }}">Corporates and innovation</a></li>
                                                <li><a href="{{ route('shopproductdetail2') }}">Government and policy</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 md:col">
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                <li><a href="{{ route('shopproductdetail2') }}">Media</a></li>
                                                <li><a href="{{ route('shopproductdetail2') }}">Events</a></li>
                                                <li><a href="{{ route('shopproductdetail2') }}">Partner with us</a></li>
                                                <li><a href="{{ route('shopproductdetail2') }}">Jobs</a></li>
                                                <li><a href="{{ route('shopproductdetail2') }}">Masthead</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                ...
                                                <li><a href="{{ route('shopproductdetail2') }}">Log in</a></li>
                                                <li><a href="{{ route('shopproductdetail2') }}">Create an account</a></li>
                                ...
                                <div class="col-12 md:col-5">
                                    <div class="widget newsletter-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            ...
                                            <p class="fs-7 fw-medium text-dark dark:text-white text-opacity-50 mt-2">By pressing the Subscribe button, you confirm that you have read and are agreeing to our <a href="{{ route('shopproductdetail2') }}" class="uc-link dark:text-white">Privacy Policy</a> and <a href="{{ route('shopproductdetail2') }}" class="uc-link dark:text-white">Terms of Use</a></p>
                        ...
                        <div class="uc-footer-bottom panel vstack lg:hstack gap-4 justify-between fs-7 text-center lg:text-start">
                            <div class="vstack lg:hstack gap-2">
                                ...
                                <ul class="footer-site-links nav-x gap-2 fw-medium justify-center lg:justify-start">
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('shopproductdetail2') }}">Privacy notice</a></li>
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('shopproductdetail2') }}">Terms of condition</a></li>
                                    <li><a class="uc-link text-underline hover:text-gray-900 dark:hover:text-white duration-150" href="{{ route('shopproductdetail2') }}">FAQ</a></li>
                                </ul>
                            </div>
